...
export function WinnerAnnouncement({ winner, currentPrizeName, onClose }: WinnerAnnouncementProps) {
  ...
  return (
    <Dialog open={!!winner} onOpenChange={onClose}>
      <DialogContent className="max-w-full max-h-full w-screen h-screen flex flex-col items-center justify-center bg-black bg-opacity-70" style={{ zIndex: 9999 }} onClick={onClose}>
        <DialogHeader>
        ...
        <div className="flex-grow flex items-center justify-center relative">
          <div 
            ...
            style={{ 
              zIndex: 10000,
              textShadow: '0 0 10px rgba(0,149,255,0.5), 0 0 20px rgba(0,149,255,0.5), 0 0 30px rgba(0,149,255,0.5), 0 0 40px #0095ff, 0 0 70px #0095ff, 0 0 80px #0095ff, 0 0 100px #0095ff, 0 0 150px #0095ff'
            }}
          >
            {winner}
          </div>
